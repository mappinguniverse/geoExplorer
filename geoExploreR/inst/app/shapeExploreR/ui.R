ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      selectInput("download_type", label = "Download type", choices = c("map.html", "map.png", "map.pdf", "map.jpeg", "map_static.png", "map_static.pdf", "map_static.jpeg", "data.geojson", "data.RData", "data.csv", "map&data.RData"), multiple = FALSE),
